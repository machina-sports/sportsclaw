...
export const SKILL_DESCRIPTIONS: Record<string, string> = {
  ...
  cricket: "Cricket — live scores via ESPN + historical data via Cricsheet",
  volleyball: "Volleyball — Dutch leagues & national teams via Nevobo",
  xctf: "Cross Country & Track — NCAA results via TFRRS & The Stride Report",
  ...
  metadata: "Metadata — team & player visual assets (logos, badges) via TheSportsDB",
